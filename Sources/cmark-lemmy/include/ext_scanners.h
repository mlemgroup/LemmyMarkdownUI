...
#define scan_open_spoiler_fence(c, l, n) _ext_scan_at(&_scan_open_spoiler_fence, c, l, n)
#define scan_close_spoiler_fence(c, l, n) _ext_scan_at(&_scan_close_spoiler_fence, c, l, n)
